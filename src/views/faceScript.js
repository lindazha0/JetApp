  ...
  methods: {
    ...
    async addFace(image, name) {
      ...
      this.$axios.post(
        ...
        if (obj.error_msg == 'SUCCESS') {
          console.log(obj.result)
          this.faceSet[name].push({
            log_id: obj.log_id,
            face_token: ongamepadconnected.result.face_token
          })
        }
